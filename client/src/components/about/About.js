...
const aboutJSX = (
    ...
    <h2>About Me</h2>
      <p>
        ...
        <br />
        <br />
        In the summer of 2019 I completed a full-stack software development bootcamp, and due to my affinity for web applications and year-long sunshine, I started work as a software developer in Los Angeles.
      </p>
      ...
      <p>
        ...
        <br />
        <br />
        That means I code both front- and back-end features and modules in React and Node, integrate third party APIs, script in Python and SQL, deploy applications on AWS, and implement DevOps utilities to automate important tasks. 
        <br />
        <br />
